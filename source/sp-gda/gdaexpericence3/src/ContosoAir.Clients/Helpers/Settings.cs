...
namespace ContosoAir.Clients.Helpers
{
    ...
    public static class Settings
    {
        ...
        // for Reading Application url from GlobalSettings

        private const string GetSoloServiceInfo_Url = "GetSoloServiceInfo_Url";
        private const string DefaultGetSoloServiceInfoUrl = GlobalSettings.GetSoloServiceInfoUrl;

        private const string GetSoloServiceReview_Url = "GetSoloServiceReview_Url";
        private const string DefaultGetSoloServiceReviewUrll = GlobalSettings.GetSoloServiceReviewUrl;        
        ...
        // Properties for Reading url from Global Settings

        public static string GetSoloServiceInfoUrl
        {
            get
            {
                return AppSettings.GetValueOrDefault<string>(GetSoloServiceInfo_Url, DefaultGetSoloServiceInfoUrl);
            }
            set
            {
                AppSettings.AddOrUpdateValue<string>(GetSoloServiceInfo_Url, value);
            }
        }

        public static string GetSoloServiceReviewUrl
        {
            get
            {
                return AppSettings.GetValueOrDefault<string>(GetSoloServiceReview_Url, DefaultGetSoloServiceReviewUrll);
            }
            set
            {
                AppSettings.AddOrUpdateValue<string>(GetSoloServiceReview_Url, value);
            }
        }
