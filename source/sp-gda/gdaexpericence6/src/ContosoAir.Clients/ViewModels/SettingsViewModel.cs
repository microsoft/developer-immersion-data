...
namespace ContosoAir.Clients.ViewModels
{
    public class SettingsViewModel : ViewModelBase
    {
        ...
        {
            get { return Settings.FlightDelayInfoUrl; }
            set
            {
                if (!value.Equals(Settings.FlightDelayInfoUrl))
                {
                    Settings.FlightDelayInfoUrl = value;
                    RaisePropertyChanged(() => FlightDelayInfoUrl);
                }
            }
        }       
