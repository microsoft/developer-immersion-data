        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch (menuItemType)
            {
                ...
                case MenuItemType.Notification:
                    return (Device.OS == TargetPlatform.Windows ? "Assets/notification_icon.png" : "notification_icon");
                case MenuItemType.GateChange:
                    return (Device.OS == TargetPlatform.Windows ? "Assets/gate_change_icon.png" : "gate_change_icon");
                default:
                    return string.Empty;
            }
        }
