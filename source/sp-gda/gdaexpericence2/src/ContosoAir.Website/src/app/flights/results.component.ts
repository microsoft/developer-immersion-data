...
import { Router } from '@angular/router'; //for view codeshare soloservice link routing
import { BookingService } from '../shared/booking.service';
import { FlightsService } from '../flights/flights.service';
import { Flight } from './flight';
import { Popup } from 'ng2-opd-popup';
import { FlightsFeedbackService } from './flightsFeedback.service';
import { CodeshareService } from '../codeshare/codeshare.service';// view codeshare soloservice link service ref

@Component({
    selector: 'results',
    templateUrl: './results.component.html',
    providers: [FlightsFeedbackService,CodeshareService]
})
export class ResultsComponent implements OnInit, OnChanges {
    ...
    //For codeshare solo service graph
    ...
    //View solo service link click 
    ViewSoloServices(flight: Flight) {
        this.bookingService.codeshareSoloServiceData.flightId = flight.id;
        this.bookingService.codeshareSoloServiceData.serviceName = "soloservice";
        this.parentRouter.navigate(['/codeshare']);
    }
    //View codeshare link click 
    ViewCodeshare(flight: Flight) {
        this.bookingService.codeshareSoloServiceData.flightId = flight.id;
        this.bookingService.codeshareSoloServiceData.serviceName = "codeshare";
        this.parentRouter.navigate(['/codeshare']);
    }
