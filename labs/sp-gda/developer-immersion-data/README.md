...
<a href="labs/gdaexperience1">Experience 1: Build globally distributed applications using Azure Cosmos DB</a>
...
<a href="labs/gdaexperience2">Experience 2: Analyzing Data relationship using the Power of Azure Cosmos DB Graph API (Gremlin Query)</a>
...
<a href="labs/gdaexperience3">Experience 3: Developing Xamarin Apps with Azure Cosmos DB and Notification Services</a>
...
<a href="labs/gdaexperience4">Experience 4: Flight Delay analysis using Cosmos DB, Spark Cluster in HDInsight and Power BI</a>
...
<a href="labs/gdaexperience5">Experience 5: Integrating Cosmos DB (SQL API) and Cognitive Services with Universal Windows Platform Application</a>
...
<a href="labs/gdaexperience6">Experience 6: Gate change notification to the user for specific flight using Azure Cosmos DB with Notification service</a>
...
<a href="labs/gdaexperience7">Experience 7: Building Intelligent Bot using Azure Bot Service and Cosmos DB</a>
