...
namespace ContosoAir.Clients.Helpers
{
    ...
    public static class Settings
    {
        ...
        private const string DefaultFlightDelayInfoUrl = GlobalSettings.FlightDelayInfoUrl;
        ...
        public static string FlightDelayInfoUrl
        {
            get
            {
                return AppSettings.GetValueOrDefault<string>(GetSoloServiceInfo_Url, DefaultFlightDelayInfoUrl);
            }
            set
            {
