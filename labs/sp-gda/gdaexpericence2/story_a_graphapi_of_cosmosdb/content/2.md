...
1. Now to configure with **Graph DB** , again switch to Azure portal and click on **Resource groups** ![](img/ResourceGroups.png) icon present in the **favorites** menu on the left side panel.
